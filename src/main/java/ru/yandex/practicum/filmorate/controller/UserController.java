...
public class UserController {
    ...
    private static final String VALID_EMAIL_EXCEPTION_MESSAGE = "Электронная должна содержать символ @";
    ...
    private void validateUser(User user) {
        try {
            ...
            if (!user.getEmail().contains("@")) {
                throw new ValidationException(VALID_EMAIL_EXCEPTION_MESSAGE);
            }
